...
export abstract class LinesConfigurationDataSource<TGetAll, TById, TCreate, TUpdate, TDelete> implements CommonMethodsCrud<TGetAll, TById, TCreate, TUpdate, TDelete> {
