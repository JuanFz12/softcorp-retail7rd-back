...
export abstract class LinesConfigurationRepository<TGetAll, TById, TCreate, TUpdate, TDelete> implements CommonMethodsCrud<TGetAll, TById, TCreate, TUpdate, TDelete> {
