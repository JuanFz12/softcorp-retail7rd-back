...
export abstract class GroupsManagementRepository<TGetAll, TById, TCreate, TUpdate, TDelete> implements CommonMethodsCrud<TGetAll, TById, TCreate, TUpdate, TDelete> {
