...
export abstract class UserManagementRepository<TGetAll, TById, TCreate, TUpdate, TDelete> implements CommonMethodsCrud<TGetAll, TById, TCreate, TUpdate, TDelete> {
